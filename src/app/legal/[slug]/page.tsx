...
const legalPages: Record<string, LegalPage> = {
  terms: {
    ...
    description: "Rules for using KhaoScan as a restaurant operator, staff member, or dine-in guest.",
    updatedAt: "24 July 2026",
    sections: [
      {
        heading: "Platform Scope",
        body: [
          "KhaoScan is an in-restaurant experience and operations platform. It is not a food delivery marketplace and does not take custody of customer food payments.",
          "Restaurants use KhaoScan to manage QR menus, tables, orders, staff workflows, payment verification, analytics, and account settings.",
        ],
      },
      {
        ...
        body: [
          ...
          "Restaurants must provide accurate registration, UPI, contact, address, and verification details. KhaoScan may suspend or reject accounts that appear fraudulent or incomplete.",
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          "Restaurant subscription plans are billed for access to KhaoScan software features. Paid plans are activated only after payment verification.",
          "Plan features may be updated over time, but KhaoScan will avoid materially reducing active paid-plan access without notice.",
        ],
      },
    ],
  },
  privacy: {
    ...
    description: "How KhaoScan handles restaurant, staff, customer, order, payment, and device notification data.",
    updatedAt: "24 July 2026",
    sections: [
      {
        heading: "Data We Collect",
        body: [
          "We collect restaurant registration details, profile settings, staff roles, menu data, table data, orders, order items, payment status, service requests, and audit records needed to operate KhaoScan.",
      ...
      },
      {
        ...
        body: [
          ...
          "Restaurant payment details are used to generate direct payment flows. KhaoScan does not store customer card details.",
        ],
      },
      {
        heading: "Security",
        body: [
          "Authentication is handled through Supabase Auth. Passwords are never stored manually in KhaoScan tables.",
  ...
  refund: {
    title: "Refund Policy",
    description: "Refund expectations for KhaoScan subscription payments and restaurant customer payments.",
    updatedAt: "24 July 2026",
    sections: [
      {
        heading: "Restaurant Subscription Payments",
        body: [
          "KhaoScan subscriptions pay for software access. Refund requests are reviewed case by case when duplicate charges, failed activation, or billing errors occur.",
      ...
      },
      {
        ...
        body: [
          "Customer food payments go directly to the restaurant through UPI, cash, or card-machine flows. KhaoScan does not hold these funds.",
      ...
      },
      {
        ...
        body: [
          "For KhaoScan subscription billing support, contact support@khaoscan.com with the restaurant name, payment reference, and issue details.",
    ...
    sections: [
      {
        ...
        body: [
          ...
          "KhaoScan provides software tools and cannot guarantee food quality, preparation speed, restaurant seating, or staff response times.",
        ],
      },
      {
        heading: "Payments",
        body: [
          ...
          "Restaurant subscription payments use UPI and activate only after the submitted transaction is manually verified by KhaoScan.",
        ],
      },
      {
        ...
        body: [
          ...
          "KhaoScan may update features, plans, or operational policies to improve security, reliability, and business fit.",
        ],
      },
    ],
  },
      ...
      <section className="mx-auto max-w-4xl px-5 py-10">
        ...
        <article className="overflow-hidden rounded-3xl border border-white/10 bg-white/[0.06] shadow-2xl shadow-black/30 backdrop-blur">
          <header className="border-b border-white/10 p-6 md:p-8">
            ...
            <p className="text-sm font-semibold uppercase tracking-[0.18em] text-orange-200">KhaoScan legal</p>
