...
export function MetricCard({
  ...
  const content = (
    ...
    >
      <div className="flex items-start justify-between gap-4">
        ...
        <div className={cn("grid h-11 w-11 shrink-0 place-items-center rounded-xl transition-transform duration-300 group-hover:scale-110", toneMap.icon)}>
  ...
  if (href) {
    return (
      <Link href={href} className="block group focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 rounded-xl">
        {content}
      </Link>
    );
  }
